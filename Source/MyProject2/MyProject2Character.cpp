...
void AMyProject2Character::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("Dash", IE_Pressed, this, &AMyProject2Character::Dash);
	PlayerInputComponent->BindAction("Dash", IE_Released, this, &AMyProject2Character::StopDash);
}
...
void AMyProject2Character::Dash()
{
	bDash = true;

}

void AMyProject2Character::StopDash()
{
	bDash = false;
